...
for (Object refObj : signature.getSignedInfo().getReferences()) {
    ...
    System.out.println("Ref URI: " + ref.getURI());

    InputStream is = ref.getDigestInputStream();
    if (is != null) {
        byte[] data = is.readAllBytes();
        System.out.println("Digest Input Data:\n" + new String(data));
    }

    boolean refValid = ref.validate(valContext);
    System.out.println("Reference valid: " + refValid);
}
...
public class SoapSigner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 🔹 Create Signature element under wsse:Security
        Element security = (Element) doc.getElementsByTagNameNS(
                "http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd",
                "Security").item(0);
